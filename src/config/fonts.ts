...
export const fonts: FontConfig[] = [
	...
	},
	{
		...
		fontName: 'Anthropic Sans',
		type: 'Static Font',
		fileUrl: '/fonts/anthropic/AnthropicSans.woff2',
		fileName: 'AnthropicSans.woff2',
		fontFace: `@font-face {\n  font-family: 'Anthropic Sans';\n  font-style: normal;\n  src: url('/fonts/anthropic/AnthropicSans.woff2') format('woff2');\n}\n@font-face {\n  font-family: 'Anthropic Sans';\n  font-style: italic;\n  src: url('/fonts/anthropic/AnthropicSans-Italic.woff2') format('woff2');\n}\n`,
		axes: [{ tag: 'wght', name: 'Weight', min: 400, max: 400, default: 400 }],
	},
	{
		id: 'anthropic-serif',
		fontFamily: "'Anthropic Serif', serif",
		fontName: 'Anthropic Serif',
		type: 'Static Font',
		fileUrl: '/fonts/anthropic/AnthropicSerif.woff2',
		fileName: 'AnthropicSerif.woff2',
		fontFace: `@font-face {\n  font-family: 'Anthropic Serif';\n  font-style: normal;\n  src: url('/fonts/anthropic/AnthropicSerif.woff2') format('woff2');\n}\n@font-face {\n  font-family: 'Anthropic Serif';\n  font-style: italic;\n  src: url('/fonts/anthropic/AnthropicSerif-Italic.woff2') format('woff2');\n}\n`,
		axes: [{ tag: 'wght', name: 'Weight', min: 400, max: 400, default: 400 }],
	},
	{
		id: 'anthropic-mono',
		fontFamily: "'Anthropic Mono', monospace",
		fontName: 'Anthropic Mono',
		type: 'Static Font',
		fileUrl: '/fonts/anthropic/AnthropicMono.woff2',
		fileName: 'AnthropicMono.woff2',
		fontFace: `@font-face {\n  font-family: 'Anthropic Mono';\n  font-style: normal;\n  src: url('/fonts/anthropic/AnthropicMono.woff2') format('woff2');\n}\n@font-face {\n  font-family: 'Anthropic Mono';\n  font-style: italic;\n  src: url('/fonts/anthropic/AnthropicMono-Italic.woff2') format('woff2');\n}\n`,
		axes: [{ tag: 'wght', name: 'Weight', min: 400, max: 400, default: 400 }],
	},
	{
		id: 'mackinac',
		...
		fontName: 'Mackinac',
		type: 'Static Font',
		fileUrl: '/fonts/mackinac/Mackinac.woff2',
		fileName: 'Mackinac.woff2',
